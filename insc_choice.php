...
<head>
    ...
    <style>
       ...
       .container-login100-form-btn a:hover {text-decoration: none;color: #fff;}
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post">
                    ...
                    <a href="insc_player.php" class="login100-form-btn" >Sign up as Player</a>
						<!-- <button class="login100-form-btn" type="submit">Sign up as Player
                        <a href="insc_player.php" class="login100-form-btn">Sign up as Player</a>
						</button> -->
                    ...
                    <a href="insc_club.php" class="login100-form-btn" >Sign up as Club</a>
					...
					<div class="flex-col-c p-t-170 p-b-40">
						...
						<a href="login.php" class="txt3" style="a:hover{color:#666666;}">
							Sign in now
						</a>
					</div>
                </div>
