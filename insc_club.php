...
if( isset($_POST['name'])  AND isset($_POST['email'])  AND isset($_POST['pass'])){
    ...
    try{
        $rs = $con->prepare("INSERT INTO club ( name, email, pass) VALUES ( ?, ?, ? )");
        $rs->execute([$name,$email,$pass]);
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter clubname">
